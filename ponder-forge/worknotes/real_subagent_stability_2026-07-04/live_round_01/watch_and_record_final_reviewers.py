#!/usr/bin/env python3
"""Wait for final reviewer verdicts and record only when complete."""
...
COLLECTOR = ROUND_DIR / "collect_and_record_final_reviewers.py"
RESULT_PATH = ROUND_DIR / "58_final_reviewer_watchdog_result.json"
LOG_PATH = ROUND_DIR / "58_final_reviewer_watchdog.log"
