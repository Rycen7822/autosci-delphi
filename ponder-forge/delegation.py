...
def prepare_delegations(store: PonderForgeStore, run_id: str) -> dict:
                ...
                "context": "\n".join(
                    [
                        ...
                        *constraint_lines,
                        ...
                        "Before your final answer, call ponder_forge_report_submit.",
                        "Do not call ponder_forge_finalize.",
    ...
    return {
        ...
        "instruction": "Immediately call native delegate_task with delegate_task_payload. Do not answer finally before ponder_forge_finalize.",
    }
